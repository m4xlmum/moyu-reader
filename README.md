...
当前是 **1.5.1**：里程碑 1（核心摸鱼能力）已完成并通过真机验证。1.3.0 把起始页
...
<img src="assets/features.webp" alt="收起成一颗球 / 底板可以淡到 0 / 三套主题，只换起始页" width="100%">
...
| [docs/spike-findings.md](docs/spike-findings.md) | 真机实测的 61 条结论：透明合成、拖动、全屏、托盘、更新网络与安装器、PDF 自渲染与键控、「注进去的样式撤不撤得掉」，以及「几份文档之间到底有没有继承路径」（主题边界就建在它的答案上）各一条 |
