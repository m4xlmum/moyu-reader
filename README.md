...
当前是 **1.3.3**：里程碑 1（核心摸鱼能力）已完成并通过真机验证。1.3.0 把起始页
...
| [docs/spike-findings.md](docs/spike-findings.md) | 真机实测的 48 条结论：透明合成、拖动、全屏、托盘、更新网络与安装器各一条 |
