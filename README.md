...
项目里相当一部分实现细节是为了不踩它们——[架构要点](#架构要点)那十四条几乎都是这么来的。

功能对标商业产品 [墨鱼阅读](https://moyuread.com/)，但**代码完全独立实现**，
不包含该产品的任何资源或代码。

当前版本 0.1.5：里程碑 1（核心摸鱼能力）已完成并通过真机验证。本地电子书阅读
...
`moyu-reader-0.1.5-x64.exe`：中文安装程序，可以自己选安装目录，不是一键装完那种。
也提供 `-x64.zip`，免安装解压即用。
...
有十四处实现与直觉相反，都是被真机验证倒逼出来的，改动前请先读
